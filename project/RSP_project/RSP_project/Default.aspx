...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <h3>Vítejte na stránkách časopisu Logos Polytechnikos</h3>
    <div class="obsah">
        <p>
        ...
        <p>
            &emsp;&emsp;&emsp;Časopis je vydáván od roku 2010 a vychází čtyřikrát ročně. Redakční rada časopisu sestává z interních i 
    ...
    recenzním řízením a jsou pečlivě redigovány.
        ...
        <p>
            &emsp;&emsp;&emsp;Tematické a obsahové zaměření časopisu, především na obory sociálně-ekonomické, zdravotnické a
    ...
    i odborníkům bez zaměstnanecké vazby k Vysoké škole polytechnické Jihlava.
        ...
        <p>
            &emsp;&emsp;&emsp;V časopisu je možné publikovat odborné články, statě, přehledové studie, recenze a 
    ...
    formálně upravené dle redakční šablony.
        ...
        <br />
        <p>
            &emsp;&emsp;&emsp;Pokud Vás zajímá, jak přispět do časopisu, pokračujte na <a class="my-link" href="/publikace">publikaci</a>.
        </p>
