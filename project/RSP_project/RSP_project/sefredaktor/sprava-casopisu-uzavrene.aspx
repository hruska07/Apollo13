<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="sprava-casopisu-uzavrene.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="obsah">
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link bg-dark text-white" href="/sefredaktor/sprava-casopisu-otevrene">Otevřené časopisy</a>
            </li>
            <li class="nav-item">
                <a class="nav-link active" href="#">Uzavřené časopisy</a>
            </li>
        </ul>
