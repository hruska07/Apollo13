...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="obsah">
        <asp:Panel ID="Panel_prehled" runat="server">
            <asp:GridView CssClass="table table-dark" ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="id_clanek" DataSourceID="SqlDataSource1" AllowSorting="True" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                <Columns>
                    ...
                    <asp:BoundField DataField="datum_clanku" HeaderText="Datum" SortExpression="datum_clanku" />
                    <asp:BoundField DataField="cele_jmeno" HeaderText="Autor" SortExpression="autor" />
                    <asp:TemplateField HeaderText="Detail">
                        <ItemTemplate>
                            <asp:Button CssClass="btn btn-info" Text="Detail" ID="select_button" runat="server" CommandName="Select" />
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString_seznam_volnych_clanku %>" SelectCommand="SELECT [Clanek].*, ([User].[jmeno] +' '+ [User].[prijmeni]) AS [cele_jmeno] FROM [Clanek] JOIN [User] ON [Clanek].[autor] = [User].[id_user]"></asp:SqlDataSource>
        </asp:Panel>
